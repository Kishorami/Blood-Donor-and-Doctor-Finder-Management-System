        ...
        <div class="container container-custom">
            <div class="col-md-12 text" style="margin: auto;">
                    <div class="get-in-touch get-in-touch-style2">
                        ...
                        <h3 class="text-center">দ্রুত সেবা পেতে আপনার নিকটবর্তী হাসপাতাল খুঁজুন</h3>
                        <form enctype="multipart/form-data" wire:submit.prevent="findHospital">
                            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="blog-wrap">
                        ...
                        @if(count($requested_hospital)<1 && $flag==1)
                            <h3 class="text-center" style="color: red; margin: auto;">আমরা দুঃখিত, আপনার কাঙ্ক্ষিত এলাকাতে  হাসপাতাল খুঁজে পাওয়া যায়নি। <br> অনুগ্রহপূর্বক আবার খুঁজে দেখুন ।।</h3>
                        @endif

                        @foreach($requested_hospital as $row)
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="sub-header_content">
                        ...
                        <h3>বিশেষজ্ঞ ডাক্তারের পরামর্শ পেতে আপনার নিকটবর্তী ডাক্তার খুঁজুন</h3>
                        <h3><a style="color: #FFD700;" href="/find_doctor">এখানে ক্লিক করুন</a></h3>
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    <div class="sub-header_content">
                        ...
                        <h3>লাইফসাইকেল বিডির ফ্রী টেলিমেডিসিন সেবা পেতে ডাক্তারের নাম্বারে কল করুন:</h3>
