    ...
    <!-- Appointments -->
        <div class="col-lg-12 col-xs-12">
            <div class="card">
                ...
                <div class="container">
                    <form enctype="multipart/form-data" wire:submit.prevent="findDonor">
                            @csrf
                    <div class="row">
                        ...
                        <div class="col-2">
                            ...
                            <select name="blood_group" class="form-control" wire:model="search_bloodgroup">
                        ...
                        <div class="col-2">
                            <label>Division</label>
                             <select class="form-control" name="post-per-page" wire:model="search_division">
                        ...
                        <div class="col-3">
                            <label>District</label>
                             <select class="form-control" name="post-per-page" wire:model="search_district">
                        ...
                        <div class="col-3">
                            <label>Thana</label>
                            <select class="form-control" name="post-per-page" wire:model="search_thana">
                        ...
                        <div class="col-2">
                            <div style="margin: auto;">
                                <button type="submit" class="btn btn-success float-right" style="margin-top: 30px;">Search</button>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="col-sm-9">
                       ...
                       {{--  <select name="blood_group" class="form-control" wire:model="search_bloodgroup">
                        ...
                        <select class="form-control" name="post-per-page" class="use-chosen" wire:model="search_division">
                            <option value="">Select Division</option>
                            @foreach($data['divisions'] as $row)
                                <option value="{{ $row->id }}">{{ $row->division_name }}</option>
                            @endforeach
                         ...
                         <select class="form-control" name="post-per-page" class="use-chosen" wire:model="search_district">
                            <option value="">Select District</option>
                            @foreach($districts as $row)
                                <option value="{{ $row->district_name }}">{{ $row->district_name }}</option>
                            @endforeach
                        ...
                        <select class="form-control" name="post-per-page" class="use-chosen" wire:model="search_location">
                            <option value="">Select Thana</option>
                            @foreach($locations as $row)
                                <option value="{{ $row->thana }}">{{ $row->thana }}</option>
                            @endforeach
                    ...
                    <table id="datatable-makesales" class="table table-bordered table-striped nowrap data-table-makesales" style="overflow-wrap: anywhere; overflow-y:scroll" width="100%">
                        ...
                        <tbody>
                            @if($searched_donors != null)
                            @foreach($searched_donors as $pro=>$donor_all)
                                <tr>
                                    <td>{{ $donor_all->id }}</td>
