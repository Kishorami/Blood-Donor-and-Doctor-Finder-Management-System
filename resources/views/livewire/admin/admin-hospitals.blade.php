            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-3">
                            <a class="btn btn-success float-right text-white" data-toggle="modal" data-target="#modalAddHospital">Add New Hospital</a>
                        </div>
                    </div>             
                </div>
                <br>
                <div class="col-12">
                    ...
                    <table id="datatable-makesales" class="table table-bordered table-striped nowrap data-table-makesales" style="overflow-wrap: anywhere;" width="100%">
                        ...
                        <tr>
                            ...
                            <th wire:click="sortBy('hospital_name')">Name</th>
                        ...
                        <tbody>
                            @foreach($allHospitals as $pro=>$hosp_all)
                                <tr>
                                    <td>{{ $hosp_all->id }}</td>
                                    <td>{{ $hosp_all->hospital_name }}</td>
                                    <td>{{ $hosp_all->location }}</td>
                                    <td>{{ $hosp_all->phone }}</td>
                                    <td>{{ $hosp_all->details }}</td>
                                    <td>
                                        <a class="btn btn-warning btn-sm text-white" wire:click="getHospital('{{ $hosp_all->id }}')" data-toggle="modal" data-target="#modalEditHospital">Edit</a>
                                        <a class="btn btn-danger waves-effect waves-light btn-sm" wire:click="deleteID('{{ $hosp_all->id }}')" data-toggle="modal" data-target="#modalDeleteComponent">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                                  ...
                                  <div class="form-group" wire:ignore>          
                                    <div class="input-group">             
                                      <div class="col-xs-12 col-sm-12 col-md-12">
                                        <strong>Name:</strong>
                                        <input type="text" class="form-control" name="hospital_name" placeholder="Hospital Name" required wire:model="hospital_name">
                                      </div>
                                    </div>
                                  </div>
                                ...
                                @endif
                                  ...
                                  <div class="form-group" wire:ignore>          
                                    <div class="input-group">             
                                      <div class="col-xs-12 col-sm-12 col-md-12">
                                        <strong>Name:</strong>
                                        <input type="text" class="form-control" name="e_hospital_name" placeholder="Hospital Name" required wire:model="e_hospital_name">
                                      </div>
                                    </div>
                                  </div>
