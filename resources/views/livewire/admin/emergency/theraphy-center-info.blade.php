        ...
        <div class="col-lg-12 col-xs-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-3">
                            <h3 class="card-title">All Theraphy Center Info</h3>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-3">
                            <a class="btn btn-success float-right text-white" data-toggle="modal" data-target="#modalAddHospital">Add Theraphy Center</a>
                        </div>
                    </div>             
                </div>
                <br>
                <div class="col-12">
                    ...
                    <table id="datatable-makesales" class="table table-bordered table-striped nowrap data-table-makesales" style="overflow-wrap: anywhere;" width="100%">
                        ...
                        <tbody>
                            @foreach($allTheraphy as $pro=>$thec_all)
                                <tr>
                                    <td>{{ $thec_all->id }}</td>
                                    <td>{{ $thec_all->name }}</td>
                                    <td>{{ $thec_all->location }}</td>
                                    <td>{{ $thec_all->phone }}</td>
                                    <td>{{ $thec_all->details }}</td>
                                    <td>
                                        <a class="btn btn-warning btn-sm text-white" wire:click="getHospital('{{ $thec_all->id }}')" data-toggle="modal" data-target="#modalEditHospital">Edit</a>
                                        <a class="btn btn-danger waves-effect waves-light btn-sm" wire:click="deleteID('{{ $thec_all->id }}')" data-toggle="modal" data-target="#modalDeleteComponent">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                    ...
                    <form role="form" enctype="multipart/form-data" wire:submit.prevent="storeHospital()">
                        ...
                        ======================================-->  
                          <div class="modal-header">
                            <h4 class="modal-title">Add Theraphy Center</h4>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form role="form" enctype="multipart/form-data" wire:submit.prevent="updateHospital()">
                        ...
                        ======================================-->  
                          <div class="modal-header">
                            <h4 class="modal-title">Edit Theraphy Center</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
