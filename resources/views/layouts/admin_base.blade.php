  ...
  {{-- <nav class="main-header navbar navbar-expand navbar-white navbar-light"> --}}
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('blood_requests') }}" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
...
<script>
  ...
  <script type="text/javascript">
      window.livewire.on('storeSomething', () => {
          ...
          $('#modalAddContent').modal('hide');
          $('#modalEditContent').modal('hide');
          $('#modalAddDoctor').modal('hide');
          $('#modalEditDoctor').modal('hide');
          $('#modalAddHospital').modal('hide');
          $('#modalEditHospital').modal('hide');
          $('#modalEditBlog').modal('hide');
          $('#modalDeleteComponent').modal('hide');
          $('#modalUpdateProud').modal('hide');
