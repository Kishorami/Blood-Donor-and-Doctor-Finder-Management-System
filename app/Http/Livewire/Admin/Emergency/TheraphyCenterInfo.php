...
class TheraphyCenterInfo extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    {
        $info = new theraphycenterinfo_table();
    ...
    public function getHospital($id)
    {
        ...
        $info = theraphycenterinfo_table::find($id);
    ...
    {
        $info = theraphycenterinfo_table::find($this->ambulance_id);
    ...
    {
        theraphycenterinfo_table::find($this->delete_id)->delete();
        $this->emit('storeSomething');
    }
    ...
    public function render()
    {
        ...
        $allTheraphy = theraphycenterinfo_table::orderBy($this->sortBy,$this->sortDirection)->search(trim($this->search))->paginate($this->paginate);
        ...
        return view('livewire.admin.emergency.theraphy-center-info',compact('allTheraphy','data'))->layout('layouts.admin_base');
    }
}
