...
class SocialInfo extends Component
{
    ...
    {
        $info = socialinfo_table::find($this->ambulance_id);
    ...
    {
        socialinfo_table::find($this->delete_id)->delete();
        $this->emit('storeSomething');
    }
    ...
    public function render()
    {
        ...
        $allSocial = socialinfo_table::orderBy($this->sortBy,$this->sortDirection)->search(trim($this->search))->paginate($this->paginate);
        ...
        return view('livewire.admin.emergency.social-info',compact('allSocial','data'))->layout('layouts.admin_base');
    }
}
