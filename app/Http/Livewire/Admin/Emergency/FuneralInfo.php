...
class FuneralInfo extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    public function getHospital($id)
    {
        ...
        $info = funeralinfo_table::find($id);
    ...
    {
        $info = funeralinfo_table::find($this->ambulance_id);
    ...
    {
        funeralinfo_table::find($this->delete_id)->delete();
        $this->emit('storeSomething');
    }
    ...
    public function render()
    {
        ...
        $allFuneral = funeralinfo_table::orderBy($this->sortBy,$this->sortDirection)->search(trim($this->search))->paginate($this->paginate);
        ...
        return view('livewire.admin.emergency.funeral-info',compact('allFuneral','data'))->layout('layouts.admin_base');
    }
}
