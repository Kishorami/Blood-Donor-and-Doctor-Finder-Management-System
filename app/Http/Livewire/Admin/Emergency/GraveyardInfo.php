...
class GraveyardInfo extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    public function getHospital($id)
    {
        ...
        $info = graveyardinfo_table::find($id);
    ...
    {
        $info = graveyardinfo_table::find($this->ambulance_id);
    ...
    {
        graveyardinfo_table::find($this->delete_id)->delete();
        $this->emit('storeSomething');
    }
    ...
    public function render()
    {
        ...
        $allGraveyard = graveyardinfo_table::orderBy($this->sortBy,$this->sortDirection)->search(trim($this->search))->paginate($this->paginate);
        ...
        return view('livewire.admin.emergency.graveyard-info',compact('allGraveyard','data'))->layout('layouts.admin_base');
    }
}
